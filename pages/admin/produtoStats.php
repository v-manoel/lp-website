...
<body class="app">   	
                    ...
                    <div class="item">
                        <div class="app-card app-card-stat shadow-sm h-100">
						    <div class="app-card-body p-3 p-lg-4">
							    <h4 class="stats-type mb-1">Some product</h4>
							    <div class="stats-figure my-2"><img src="../../commom/img/examples/produtos.svg" class="m-auto" width="100px" alt=""></div>
				        ...
				        <div class="app-card app-card-chart h-100 shadow-sm">
					        ...
					        <div class="app-card-body p-3 p-lg-4">
						        ...
						        <div class="chart-container">
				                    <canvas id="product-donut" ></canvas>
						        </div>
					        </div><!--//app-card-body-->
				        </div><!--//app-card-->
			        </div><!--//col-->
                    <div class="col-12 col-lg-6">
				        <div class="app-card app-card-chart h-100 shadow-sm">
					        <div class="app-card-header p-3">
						        <div class="row justify-content-between align-items-center">
							        <div class="col-auto">
						                <h4 class="app-card-title">Histórico de vendas</h4>
							        </div><!--//col-->
							        <div class="col-auto">
								        <div class="card-header-action">
											<select class="form-select form-select-sm ml-auto d-inline-flex w-auto ">
					...
					<div class="col-12 col-lg-12 h-25">
				        <div class="app-card app-card-chart h-100 shadow-sm">
					        <div class="app-card-header p-3">
						        <div class="row justify-content-between align-items-center">
							        <div class="col-auto">
						                <h4 class="app-card-title text-warning">Valor total em vendas</h4>
							        </div><!--//col-->
							        <div class="col-auto">
					        ...
					        <div class="app-card-body p-3 p-lg-4">
						        ...
						        <div class="chart-container">
				                    <canvas id="prod-bar" ></canvas><!-- canvas-barchart -->
						        </div>
					        </div><!--//app-card-body-->
				        </div><!--//app-card-->
			        </div><!--//col-->
    ...
    <script src="js/product-graphs.js"></script>
