							        ...
							        <table class="table table-borderless mb-0">
										...
										<tbody>
											<tr class="border-bottom border-secondary">
												<td class="text-warning">Limpeza</td>
											...
											<tr class="border-bottom border-secondary">
												<td class="text-warning">Enlatados</td>
												<td class="stat-cell">67</td>
												<td class="stat-cell">23%</td>
											</tr>
											<tr class="border-bottom border-secondary">
												<td class="text-warning">Carros</td>
											...
											<tr class="border-bottom border-secondary">
												<td class="text-warning">Eletrodomésticos</td>
												<td class="stat-cell">24</td>
												<td class="stat-cell">-</td>
											</tr>
											<tr class="border-bottom border-secondary">
												<td class="text-warning">Brinquedos</td>
							...
							<div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
								<div class="app-card-header p-3 border-bottom-0">
									<div class="row align-items-center gx-3">
										...
										<div class="col-auto">
											<h4 class="app-card-title text-light">Invoices</h4>
										</div><!--//col-->
									</div><!--//row-->
								</div><!--//app-card-header-->
								<div class="app-card-body px-4">
									
									<div class="intro text-warning">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam aliquet eros vel diam semper mollis.</div>
								</div><!--//app-card-body-->
								<div class="app-card-footer p-4 m-auto mt-auto">
								   <a class="btn btn-warning text-dark" href="#">Create New</a>
								</div><!--//app-card-footer-->
							</div><!--//app-card-->
						</div><!--//col-->
						<div class="col-12 col-lg-12">
							<div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
								<div class="app-card-header p-3 border-bottom-0">
									<div class="row align-items-center gx-3">
										...
										<div class="col-auto">
											<h4 class="app-card-title text-light">Apps</h4>
										</div><!--//col-->
									</div><!--//row-->
								</div><!--//app-card-header-->
								<div class="app-card-body px-4">
									
									<div class="intro text-warning">Pellentesque varius, elit vel volutpat sollicitudin, lacus quam efficitur augue</div>
								</div><!--//app-card-body-->
								<div class="app-card-footer p-4 m-auto mt-auto">
								   <a class="btn btn-warning text-dark" href="#">Create New</a>
								</div><!--//app-card-footer-->
							...
							<div class="app-card app-card-basic d-flex flex-column align-items-start shadow-sm">
								<div class="app-card-header p-3 border-bottom-0">
									<div class="row align-items-center gx-3">
										...
										<div class="col-auto">
											<h4 class="app-card-title text-light">Tools</h4>
										</div><!--//col-->
									</div><!--//row-->
								</div><!--//app-card-header-->
								<div class="app-card-body px-4">
									
									<div class="intro text-warning">Sed maximus, libero ac pharetra elementum, turpis nisi molestie neque, et tincidunt velit turpis non enim.</div>
								</div><!--//app-card-body-->
								<div class="app-card-footer p-4 m-auto mt-auto">
								   <a class="btn btn-warning text-dark" href="#">Create New</a>
								</div><!--//app-card-footer-->
