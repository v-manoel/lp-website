...
<body>
    ...
    <div class="tablet dark-bg container-fluid p-0">
        <div class="content container-fluid m-0">
            ...
            <div class="row grid-menu">
                ...
                <div class="col-md-4 text-center mb-5 ">
                    <div class="menu-icon container">
                        <a href="pedidos.html" class="text-decoration-none text-warning">
            ...
            <div class="row footer align-items-center p-1">
                ...
                <div class=" text-center" id="return-btn">
                    <a href="login.html" class="text-secondary"><i class="bi bi-arrow-return-left h3"></i></a>
                </div>
