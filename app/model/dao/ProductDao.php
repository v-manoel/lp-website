...
class ProductDao{
    ...
    public function insert(Product $product){
        try{
            ...
            $stmt->bindParam(":title",$product->getTitle());
            $stmt->bindParam(":description",$product->getDescription());
            $stmt->bindParam(":price",$product->getPrice());
            $stmt->bindParam(":offer",$product->getOffer());
            $stmt->bindParam(":source",$product->getSource());
    ...
    public function selectById(Product $product){
        try{
            ...
            if($stmt->rowCount() == 1){
                ...
                $img_stmt->bindParam(":product_id", $product->getId());
                $img_stmt->execute();
                ...
                $cat_stmt->bindParam(":product_id", $product->getId());
                $cat_stmt->execute();
    ...
    public function allByCategory(Category $category)
    {
        try {
            ...
            $stmt->bindParam(":id_category", $category->getId());
            $stmt->execute();
