...
<div class="row container-fluid p-0 m-0 col-2">
  ...
  <form onsubmit="return confirmDeleteAccount()" action="<?= DIRPAGE . 'account/page/delete' ?>" method="post">
      <input type="password" name="del_pswd" id="del_pswd" hidden>
      <button type="submit" class="btn btn-danger fw-normal text-white text-decoration-none war">Desativar conta</button>
    </form>
  </div>
</div>